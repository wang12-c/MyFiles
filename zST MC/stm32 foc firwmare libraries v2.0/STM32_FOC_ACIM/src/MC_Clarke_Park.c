...
#define MAX_MODULE      30145   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*92%
...
#define MAX_MODULE      30473   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*93%
...
#define MAX_MODULE      30800   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*94%
...
#define MAX_MODULE      31128   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*95%
...
#define MAX_MODULE      31456   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*96%
...
#define MAX_MODULE      31783   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*97%
...
#define MAX_MODULE      32111   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*98%
...
#define MAX_MODULE      32439   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*99%
...
#define MAX_MODULE      32767   // root(Id^2+Iq^2) <= MAX_MODULE = 32767*100%
...
*                  qId=qIalpha_tmp*Cos(theta)+qIbeta_tmp*Sin(Theta)
*                  qIq=-qIalpha_tmp*Sin(Theta)+qIbeta_tmp*Cos(Theta)                 
...
*                  qValfa=qVd*Cos(theta)-qVq*Sin(theta)
*                  qVbeta=qVq*Cos(theta)+qVd*Sin(theta)                  
* Input          : Stat_Volt_q_d.
