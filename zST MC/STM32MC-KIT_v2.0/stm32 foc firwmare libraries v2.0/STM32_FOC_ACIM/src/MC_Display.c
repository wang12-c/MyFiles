  ...
  { 
    ...
    switch(bPresent_Visualization)
    {
...
#elif defined(TACHO)
        temp = (s16)(TAC_GetRotorFreqInHz()*6);
#endif        
      ...
      case(VISUALIZATION_5):
        ...
        LCD_DisplayChar(Line5, 320-16*CHAR_11, (u8)(((temp%1000)/100)+0x30));
        LCD_DisplayChar(Line5, 320-16*CHAR_12, (u8)(((temp%100)/10)+0x30));
        LCD_DisplayChar(Line5, 320-16*CHAR_13, (u8)((temp%10)+0x30));
      ...
      case(VISUALIZATION_7):
        ...
        {  
          ...
          else if ( (wGlobal_Flags & SPEED_FDBK_TIMED_OUT) ==  SPEED_FDBK_TIMED_OUT)
          {
...
{ u32 i;
  ...
  LCD_DisplayChar(Line,(u16)(320-(16*(bFirstchar+1))), (u8)(((number/10000))+0x30));
}    
